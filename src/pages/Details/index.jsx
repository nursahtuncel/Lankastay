    ...
    <section className="details-page">
      ...
      <div className="details-page-header">
        <div className="details-page-pagetitleimplementation">
          <PageTitleImplementation title="Blue Origin Fams" description="Galle, Sri Lanka" />
        </div>
      ...
      <div className="about-and-price">
        <div className="about-and-price-about">
          ...
          <p className="about-text">Minimal techno is a minimalist subgenre of techno music. It is characterized by a stripped-down aesthetic that exploits the use of repetition and understated development. Minimal techno is thought to have been originally developed in the early 1990s by Detroit-based producers Robert Hood and Daniel Bell.</p>
          <p className="about-text">Such trends saw the demise of the soul-infused techno that typified the original Detroit sound. Robert Hood has noted that he and Daniel Bell both realized something was missing from techno in the post-rave era.</p>
        </div>
